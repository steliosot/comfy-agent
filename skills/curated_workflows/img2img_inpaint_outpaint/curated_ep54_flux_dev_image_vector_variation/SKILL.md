---
name: curated_ep54_flux_dev_image_vector_variation
description: >
  Curated ComfyUI workflow imported from `EP54 Flux Dev - Image Vector Variation.json`.
...
Curated workflow skill generated from `EP54 Flux Dev - Image Vector Variation.json`.
...
- Original: `comfy-data/workflows/EP54 Flux Dev - Image Vector Variation.json`
