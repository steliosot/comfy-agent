---
name: curated_bytedance_seedream_4_img2img
description: >
  Curated ComfyUI workflow imported from `ByteDance Seedream 4 - img2img.json`.
...
# curated_bytedance_seedream_4_img2img

Curated workflow skill generated from `ByteDance Seedream 4 - img2img.json`.
...
- Original: `comfy-data/workflows/ByteDance Seedream 4 - img2img.json`
