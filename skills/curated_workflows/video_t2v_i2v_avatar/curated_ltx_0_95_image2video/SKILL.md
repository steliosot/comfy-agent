...
description: >
  Curated ComfyUI workflow imported from `LTX 0.95 image2video.json`.
...
Curated workflow skill generated from `LTX 0.95 image2video.json`.
...
- Original: `comfy-data/workflows/LTX 0.95 image2video.json`
