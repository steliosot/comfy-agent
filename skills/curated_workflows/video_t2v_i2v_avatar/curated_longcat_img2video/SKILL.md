---
name: curated_longcat_img2video
description: >
  Curated ComfyUI workflow imported from `LongCat img2video.json`.
...
Curated workflow skill generated from `LongCat img2video.json`.
...
- Original: `comfy-data/workflows/LongCat img2video.json`
