...
description: >
  Curated ComfyUI workflow imported from `LongCat img2video - Easy to Extend.json`.
...
# curated_longcat_img2video_easy_to_extend

Curated workflow skill generated from `LongCat img2video - Easy to Extend.json`.
...
- Original: `comfy-data/workflows/LongCat img2video - Easy to Extend.json`
