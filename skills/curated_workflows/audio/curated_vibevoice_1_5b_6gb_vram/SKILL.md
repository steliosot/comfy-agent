...
description: >
  Curated ComfyUI workflow imported from `VibeVoice 1.5B - 6GB VRAM.json`.
...
# curated_vibevoice_1_5b_6gb_vram

Curated workflow skill generated from `VibeVoice 1.5B - 6GB VRAM.json`.
...
- Original: `comfy-data/workflows/VibeVoice 1.5B - 6GB VRAM.json`
