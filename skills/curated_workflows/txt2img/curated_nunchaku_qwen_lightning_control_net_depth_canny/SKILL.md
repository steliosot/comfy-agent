---
name: curated_nunchaku_qwen_lightning_control_net_depth_canny
description: >
  Curated ComfyUI workflow imported from `Nunchaku Qwen Lightning + Control Net Depth Canny.json`.
...
# curated_nunchaku_qwen_lightning_control_net_depth_canny

Curated workflow skill generated from `Nunchaku Qwen Lightning + Control Net Depth Canny.json`.
...
- Original: `comfy-data/workflows/Nunchaku Qwen Lightning + Control Net Depth Canny.json`
