---
name: curated_ep45_flux_dev_q8_gguf_with_controlnet_canny
description: >
  Curated ComfyUI workflow imported from `Ep45 Flux Dev Q8 GGUF with ControlNet Canny.json`.
...
Curated workflow skill generated from `Ep45 Flux Dev Q8 GGUF with ControlNet Canny.json`.
...
- Original: `comfy-data/workflows/Ep45 Flux Dev Q8 GGUF with ControlNet Canny.json`
