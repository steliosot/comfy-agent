#!/usr/bin/env python3
"""CLI wrapper for skills.curated_workflows.txt2img.curated_hidream_i1_fast_q8_gguf_text2image.skill.run"""
...
from skills.curated_workflows.txt2img.curated_hidream_i1_fast_q8_gguf_text2image.skill import run
