---
name: curated_ep45_flux_dev_q8_gguf_with_controlnet_dw_pose_lora
description: >
  Curated ComfyUI workflow imported from `Ep45 Flux Dev Q8 GGUF with ControlNet DW Pose + Lora.json`.
...
# curated_ep45_flux_dev_q8_gguf_with_controlnet_dw_pose_lora

Curated workflow skill generated from `Ep45 Flux Dev Q8 GGUF with ControlNet DW Pose + Lora.json`.
...
- https://civitai.com/api/download/models/895148?type=Model&format=SafeTensor
...
- Original: `comfy-data/workflows/Ep45 Flux Dev Q8 GGUF with ControlNet DW Pose + Lora.json`
