---
name: curated_nunchaku_qwen_lightning_control_net_pose
description: >
  Curated ComfyUI workflow imported from `Nunchaku Qwen Lightning + Control Net Pose.json`.
...
# curated_nunchaku_qwen_lightning_control_net_pose

Curated workflow skill generated from `Nunchaku Qwen Lightning + Control Net Pose.json`.
...
- Original: `comfy-data/workflows/Nunchaku Qwen Lightning + Control Net Pose.json`
