---
name: curated_ep45_flux_dev_q8_gguf_with_controlnet_depth_dw_pose
description: >
  Curated ComfyUI workflow imported from `Ep45 Flux Dev Q8 GGUF with ControlNet Depth + DW Pose.json`.
...
# curated_ep45_flux_dev_q8_gguf_with_controlnet_depth_dw_pose

Curated workflow skill generated from `Ep45 Flux Dev Q8 GGUF with ControlNet Depth + DW Pose.json`.
...
- Original: `comfy-data/workflows/Ep45 Flux Dev Q8 GGUF with ControlNet Depth + DW Pose.json`
