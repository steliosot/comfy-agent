---
name: curated_qwen_image_edit_transform_to_line_drawing
description: >
  Curated ComfyUI workflow imported from `Qwen Image Edit - Transform to Line Drawing.json`.
...
Curated workflow skill generated from `Qwen Image Edit - Transform to Line Drawing.json`.
...
- `lora`: `LineDrawing03_CE_QWEN_AIT3k.safetensors` -> `models/loras`
...
- Original: `comfy-data/workflows/Qwen Image Edit - Transform to Line Drawing.json`
