---
name: curated_qwen_image_edit_replace_text
description: >
  Curated ComfyUI workflow imported from `Qwen Image Edit - Replace Text.json`.
...
# curated_qwen_image_edit_replace_text

Curated workflow skill generated from `Qwen Image Edit - Replace Text.json`.
...
- Original: `comfy-data/workflows/Qwen Image Edit - Replace Text.json`
