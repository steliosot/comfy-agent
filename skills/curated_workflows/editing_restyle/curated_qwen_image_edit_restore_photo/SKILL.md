---
name: curated_qwen_image_edit_restore_photo
description: >
  Curated ComfyUI workflow imported from `Qwen Image Edit - Restore Photo.json`.
...
# curated_qwen_image_edit_restore_photo

Curated workflow skill generated from `Qwen Image Edit - Restore Photo.json`.
...
- Original: `comfy-data/workflows/Qwen Image Edit - Restore Photo.json`
