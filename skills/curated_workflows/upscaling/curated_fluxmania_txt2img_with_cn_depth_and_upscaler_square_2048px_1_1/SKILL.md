---
name: curated_fluxmania_txt2img_with_cn_depth_and_upscaler_square_2048px_1_1
description: >
  Curated ComfyUI workflow imported from `Fluxmania txt2img with CN Depth and Upscaler - Square 2048px 1-1.json`.
...
Curated workflow skill generated from `Fluxmania txt2img with CN Depth and Upscaler - Square 2048px 1-1.json`.
...
- Original: `comfy-data/workflows/Fluxmania txt2img with CN Depth and Upscaler - Square 2048px 1-1.json`
