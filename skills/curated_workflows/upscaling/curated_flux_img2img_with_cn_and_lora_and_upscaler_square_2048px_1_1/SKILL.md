---
name: curated_flux_img2img_with_cn_and_lora_and_upscaler_square_2048px_1_1
description: >
  Curated ComfyUI workflow imported from `Flux img2img with CN and Lora and Upscaler - Square 2048px 1-1.json`.
...
# curated_flux_img2img_with_cn_and_lora_and_upscaler_square_2048px_1_1

Curated workflow skill generated from `Flux img2img with CN and Lora and Upscaler - Square 2048px 1-1.json`.
...
- Original: `comfy-data/workflows/Flux img2img with CN and Lora and Upscaler - Square 2048px 1-1.json`
