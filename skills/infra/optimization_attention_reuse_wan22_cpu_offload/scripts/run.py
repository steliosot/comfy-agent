#!/usr/bin/env python3
"""CLI wrapper for optimization_attention_reuse_wan22_cpu_offload"""
...
def main():
    parser = argparse.ArgumentParser(description="Run optimization_attention_reuse_wan22_cpu_offload skill")
