#!/usr/bin/env python3
"""CLI wrapper for optimization_cpu_offload"""
...
from skills.infra.optimization_cpu_offload.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run optimization_cpu_offload skill")
