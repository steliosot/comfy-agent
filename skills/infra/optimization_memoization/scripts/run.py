#!/usr/bin/env python3
"""CLI wrapper for optimization_memoization"""
...
from skills.infra.optimization_memoization.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run optimization_memoization skill")
