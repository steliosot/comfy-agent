#!/usr/bin/env python3
"""CLI wrapper for skills.infra.agentic_plan.skill.run"""
...
from skills.infra.agentic_plan.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run agentic_plan skill")
