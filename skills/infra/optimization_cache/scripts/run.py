#!/usr/bin/env python3
"""CLI wrapper for optimization_cache"""
...
from skills.infra.optimization_cache.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run optimization_cache skill")
