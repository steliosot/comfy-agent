#!/usr/bin/env python3
"""CLI wrapper for optimization_model_lru"""
...
from skills.infra.optimization_model_lru.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run optimization_model_lru skill")
