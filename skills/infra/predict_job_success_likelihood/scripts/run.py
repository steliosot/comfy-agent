#!/usr/bin/env python3
"""CLI wrapper for skills.infra.predict_job_success_likelihood.skill.run"""
...
def main():
    parser = argparse.ArgumentParser(description="Run predict_job_success_likelihood skill")
