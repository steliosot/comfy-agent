#!/usr/bin/env python3
"""CLI wrapper for optimization_lazy_loading"""
...
from skills.infra.optimization_lazy_loading.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run optimization_lazy_loading skill")
