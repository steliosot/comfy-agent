#!/usr/bin/env python3
"""CLI wrapper for skills.infra.list_curated_workflows.skill.run"""
...
from skills.infra.list_curated_workflows.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run list_curated_workflows skill")
