#!/usr/bin/env python3
"""CLI wrapper for skills.infra.get_queue_status.skill.run"""
...
from skills.infra.get_queue_status.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run get_queue_status skill")
