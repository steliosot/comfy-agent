#!/usr/bin/env python3
"""CLI wrapper for optimization_none"""
...
from skills.infra.optimization_none.skill import run


def main():
    parser = argparse.ArgumentParser(description="Run optimization_none skill")
