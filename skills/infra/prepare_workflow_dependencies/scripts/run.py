#!/usr/bin/env python3
"""CLI wrapper for skills.infra.prepare_workflow_dependencies.skill.run"""
...
def main():
    parser = argparse.ArgumentParser(description="Run prepare_workflow_dependencies skill")
