...
description: >
  Workflow wrapper imported from `Flux txt2img with CN Pose and Upscaler - 2K Landscape 16-9.json`.
...
# workflow_flux_txt2img_with_cn_pose_and_upscaler_2k_landscape_16_9

Imported workflow skill generated from `Flux txt2img with CN Pose and Upscaler - 2K Landscape 16-9.json`.
