---
name: workflow_ep52_flux_1_kontext_dev_change_the_text
description: >
  Workflow wrapper imported from `EP52 Flux 1 Kontext Dev - Change the Text.json`.
...
# workflow_ep52_flux_1_kontext_dev_change_the_text

Imported workflow skill generated from `EP52 Flux 1 Kontext Dev - Change the Text.json`.
