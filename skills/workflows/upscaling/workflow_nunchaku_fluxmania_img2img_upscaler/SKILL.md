---
name: workflow_nunchaku_fluxmania_img2img_upscaler
description: >
  Workflow wrapper imported from `Nunchaku Fluxmania img2img + Upscaler.json`.
...
# workflow_nunchaku_fluxmania_img2img_upscaler

Imported workflow skill generated from `Nunchaku Fluxmania img2img + Upscaler.json`.
