---
name: workflow_fluxmania_txt2img_collage_with_upscaler_square_2048px_1_1
description: >
  Workflow wrapper imported from `Fluxmania txt2img Collage with Upscaler - Square 2048px 1-1.json`.
...
Imported workflow skill generated from `Fluxmania txt2img Collage with Upscaler - Square 2048px 1-1.json`.
