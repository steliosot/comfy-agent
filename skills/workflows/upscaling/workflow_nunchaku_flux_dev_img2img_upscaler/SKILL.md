---
name: workflow_nunchaku_flux_dev_img2img_upscaler
description: >
  Workflow wrapper imported from `Nunchaku Flux Dev img2img + Upscaler.json`.
...
Imported workflow skill generated from `Nunchaku Flux Dev img2img + Upscaler.json`.
