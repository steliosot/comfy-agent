---
name: workflow_nunchaku_fluxmania_txt2img_upscaler
description: >
  Workflow wrapper imported from `Nunchaku Fluxmania txt2img + Upscaler.json`.
...
Imported workflow skill generated from `Nunchaku Fluxmania txt2img + Upscaler.json`.
