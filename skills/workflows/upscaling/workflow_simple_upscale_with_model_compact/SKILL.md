---
name: workflow_simple_upscale_with_model_compact
description: >
  Workflow wrapper imported from `Simple Upscale With Model COMPACT.json`.
...
# workflow_simple_upscale_with_model_compact

Imported workflow skill generated from `Simple Upscale With Model COMPACT.json`.
