---
name: workflow_fluxmania_txt2img_with_cn_canny_and_upscaler_square_2048px_1_1
description: >
  Workflow wrapper imported from `Fluxmania txt2img with CN Canny and Upscaler - Square 2048px 1-1.json`.
...
# workflow_fluxmania_txt2img_with_cn_canny_and_upscaler_square_2048px_1_1

Imported workflow skill generated from `Fluxmania txt2img with CN Canny and Upscaler - Square 2048px 1-1.json`.
