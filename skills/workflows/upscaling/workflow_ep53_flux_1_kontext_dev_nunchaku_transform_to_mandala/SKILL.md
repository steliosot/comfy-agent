---
name: workflow_ep53_flux_1_kontext_dev_nunchaku_transform_to_mandala
description: >
  Workflow wrapper imported from `EP53 Flux 1 Kontext Dev (Nunchaku) - Transform to Mandala.json`.
...
# workflow_ep53_flux_1_kontext_dev_nunchaku_transform_to_mandala

Imported workflow skill generated from `EP53 Flux 1 Kontext Dev (Nunchaku) - Transform to Mandala.json`.
...
- https://huggingface.co/Pixaroma/flux-kontext-loras/resolve/main/transform_to_mandala.safetensors?download=true
