---
name: curated_fluxmania_txt2img_with_cn_pose_and_upscaler_portrait_instagram_1080x1350px_4_5
description: >
  Curated ComfyUI workflow imported from `Fluxmania txt2img with CN Pose and Upscaler - Portrait Instagram 1080x1350px 4-5.json`.
...
# curated_fluxmania_txt2img_with_cn_pose_and_upscaler_portrait_instagram_1080x1350px_4_5

Curated workflow skill generated from `Fluxmania txt2img with CN Pose and Upscaler - Portrait Instagram 1080x1350px 4-5.json`.
...
- Original: `comfy-data/workflows/Fluxmania txt2img with CN Pose and Upscaler - Portrait Instagram 1080x1350px 4-5.json`
...
- Max latent resolution hint: `880`x`1088`
