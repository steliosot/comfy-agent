---
name: workflow_ep52_flux_1_kontext_dev_change_the_color
description: >
  Workflow wrapper imported from `EP52 Flux 1 Kontext Dev - Change the Color.json`.
...
# workflow_ep52_flux_1_kontext_dev_change_the_color

Imported workflow skill generated from `EP52 Flux 1 Kontext Dev - Change the Color.json`.
