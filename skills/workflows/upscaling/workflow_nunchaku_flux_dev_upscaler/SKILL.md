---
name: workflow_nunchaku_flux_dev_upscaler
description: >
  Workflow wrapper imported from `Nunchaku Flux Dev Upscaler.json`.
...
Imported workflow skill generated from `Nunchaku Flux Dev Upscaler.json`.
