---
name: workflow_icon_design_set_of_6_flux_t2i_cn_upscale
description: >
  Workflow wrapper imported from `Icon Design Set of 6 Flux t2i + CN + Upscale.json`.
...
# workflow_icon_design_set_of_6_flux_t2i_cn_upscale

Imported workflow skill generated from `Icon Design Set of 6 Flux t2i + CN + Upscale.json`.
...
- Max latent resolution hint: `1024`x`704`
