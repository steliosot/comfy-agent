---
name: workflow_flux_krea_nunchaku_txt2img_with_upscaler
description: >
  Workflow wrapper imported from `Flux Krea (Nunchaku) txt2img with Upscaler.json`.
...
# workflow_flux_krea_nunchaku_txt2img_with_upscaler

Imported workflow skill generated from `Flux Krea (Nunchaku) txt2img with Upscaler.json`.
