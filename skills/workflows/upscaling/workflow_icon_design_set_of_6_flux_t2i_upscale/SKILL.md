---
name: workflow_icon_design_set_of_6_flux_t2i_upscale
description: >
  Workflow wrapper imported from `Icon Design Set of 6 Flux t2i + Upscale.json`.
...
# workflow_icon_design_set_of_6_flux_t2i_upscale

Imported workflow skill generated from `Icon Design Set of 6 Flux t2i + Upscale.json`.
...
- Max latent resolution hint: `1152`x`768`
