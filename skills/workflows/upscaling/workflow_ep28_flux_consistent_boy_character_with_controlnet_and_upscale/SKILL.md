---
name: workflow_ep28_flux_consistent_boy_character_with_controlnet_and_upscale
description: >
  Workflow wrapper imported from `Ep28 Flux Consistent Boy Character with ControlNet and Upscale.json`.
...
# workflow_ep28_flux_consistent_boy_character_with_controlnet_and_upscale

Imported workflow skill generated from `Ep28 Flux Consistent Boy Character with ControlNet and Upscale.json`.
