---
name: workflow_flux_txt2img_with_cn_canny_and_upscaler_2k_landscape_16_9
description: >
  Workflow wrapper imported from `Flux txt2img with CN Canny and Upscaler - 2K Landscape 16-9.json`.
...
# workflow_flux_txt2img_with_cn_canny_and_upscaler_2k_landscape_16_9

Imported workflow skill generated from `Flux txt2img with CN Canny and Upscaler - 2K Landscape 16-9.json`.
...
- Max latent resolution hint: `1344`x`768`
