---
name: workflow_flux_img2img_variation_with_upscaler_2k_landscape_16_9
description: >
  Workflow wrapper imported from `Flux img2img Variation with Upscaler - 2K Landscape 16-9.json`.
...
Imported workflow skill generated from `Flux img2img Variation with Upscaler - 2K Landscape 16-9.json`.
