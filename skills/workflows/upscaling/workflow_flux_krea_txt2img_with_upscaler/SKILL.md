---
name: workflow_flux_krea_txt2img_with_upscaler
description: >
  Workflow wrapper imported from `Flux Krea txt2img with Upscaler.json`.
...
# workflow_flux_krea_txt2img_with_upscaler

Imported workflow skill generated from `Flux Krea txt2img with Upscaler.json`.
