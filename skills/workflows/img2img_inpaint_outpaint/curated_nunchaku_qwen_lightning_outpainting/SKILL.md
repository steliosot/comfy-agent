---
name: curated_nunchaku_qwen_lightning_outpainting
description: >
  Curated ComfyUI workflow imported from `Nunchaku Qwen Lightning - Outpainting.json`.
...
# curated_nunchaku_qwen_lightning_outpainting

Curated workflow skill generated from `Nunchaku Qwen Lightning - Outpainting.json`.
...
- Original: `comfy-data/workflows/Nunchaku Qwen Lightning - Outpainting.json`
