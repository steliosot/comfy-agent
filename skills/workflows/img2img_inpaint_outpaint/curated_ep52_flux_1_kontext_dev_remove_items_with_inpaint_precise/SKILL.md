---
name: curated_ep52_flux_1_kontext_dev_remove_items_with_inpaint_precise
description: >
  Curated ComfyUI workflow imported from `EP52 Flux 1 Kontext Dev - Remove Items with Inpaint - Precise.json`.
...
Curated workflow skill generated from `EP52 Flux 1 Kontext Dev - Remove Items with Inpaint - Precise.json`.
...
- Original: `comfy-data/workflows/EP52 Flux 1 Kontext Dev - Remove Items with Inpaint - Precise.json`
