---
name: curated_ep18_sdxl_realcartoon_img2img_with_controlnet
description: >
  Curated ComfyUI workflow imported from `EP18 SDXL RealCartoon IMG2IMG with ControlNet.json`.
...
# curated_ep18_sdxl_realcartoon_img2img_with_controlnet

Curated workflow skill generated from `EP18 SDXL RealCartoon IMG2IMG with ControlNet.json`.
...
- `checkpoint`: `realcartoonXL_v7.safetensors` -> `models/checkpoints`
...
- Original: `comfy-data/workflows/EP18 SDXL RealCartoon IMG2IMG with ControlNet.json`
