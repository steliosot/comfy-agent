---
name: curated_nunchaku_qwen_lightning_control_net_inpainting
description: >
  Curated ComfyUI workflow imported from `Nunchaku Qwen Lightning + Control Net Inpainting.json`.
...
# curated_nunchaku_qwen_lightning_control_net_inpainting

Curated workflow skill generated from `Nunchaku Qwen Lightning + Control Net Inpainting.json`.
...
- Original: `comfy-data/workflows/Nunchaku Qwen Lightning + Control Net Inpainting.json`
