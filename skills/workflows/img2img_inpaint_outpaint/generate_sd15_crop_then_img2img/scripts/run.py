#!/usr/bin/env python3
"""CLI wrapper for skills.workflows.img2img_inpaint_outpaint.generate_sd15_crop_then_img2img.skill.run"""
...
def main():
    parser = argparse.ArgumentParser(description="Run generate_sd15_crop_then_img2img skill")
    parser.add_argument(
        "--args",
        default="{}",
