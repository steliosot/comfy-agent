---
name: workflow_ep18_sdxl_realcartoon_with_flux_img2img_with_controlnet
description: >
  Workflow wrapper imported from `EP18 SDXL RealCartoon with FLUX IMG2IMG with ControlNet.json`.
...
# workflow_ep18_sdxl_realcartoon_with_flux_img2img_with_controlnet

Imported workflow skill generated from `EP18 SDXL RealCartoon with FLUX IMG2IMG with ControlNet.json`.
