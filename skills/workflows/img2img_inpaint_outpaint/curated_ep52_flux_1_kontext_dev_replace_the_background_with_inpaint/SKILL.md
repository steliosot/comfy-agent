---
name: curated_ep52_flux_1_kontext_dev_replace_the_background_with_inpaint
description: >
  Curated ComfyUI workflow imported from `EP52 Flux 1 Kontext Dev - Replace the Background with Inpaint.json`.
...
# curated_ep52_flux_1_kontext_dev_replace_the_background_with_inpaint

Curated workflow skill generated from `EP52 Flux 1 Kontext Dev - Replace the Background with Inpaint.json`.
...
- Original: `comfy-data/workflows/EP52 Flux 1 Kontext Dev - Replace the Background with Inpaint.json`
