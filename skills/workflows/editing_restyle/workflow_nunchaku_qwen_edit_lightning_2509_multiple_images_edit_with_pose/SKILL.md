---
name: workflow_nunchaku_qwen_edit_lightning_2509_multiple_images_edit_with_pose
description: >
  Workflow wrapper imported from `Nunchaku Qwen Edit Lightning 2509 - Multiple Images Edit with Pose.json`.
...
Imported workflow skill generated from `Nunchaku Qwen Edit Lightning 2509 - Multiple Images Edit with Pose.json`.
