---
name: workflow_qwen_image_edit_make_logo_3d
description: >
  Workflow wrapper imported from `Qwen Image Edit - Make Logo 3D.json`.
...
# workflow_qwen_image_edit_make_logo_3d

Imported workflow skill generated from `Qwen Image Edit - Make Logo 3D.json`.
