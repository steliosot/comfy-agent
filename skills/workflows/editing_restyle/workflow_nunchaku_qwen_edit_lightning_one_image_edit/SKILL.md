---
name: workflow_nunchaku_qwen_edit_lightning_one_image_edit
description: >
  Workflow wrapper imported from `Nunchaku Qwen Edit Lightning One Image Edit.json`.
...
# workflow_nunchaku_qwen_edit_lightning_one_image_edit

Imported workflow skill generated from `Nunchaku Qwen Edit Lightning One Image Edit.json`.
