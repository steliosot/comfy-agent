---
name: curated_qwen_image_edit_transform_to_pencil_drawing
description: >
  Curated ComfyUI workflow imported from `Qwen Image Edit - Transform to Pencil Drawing.json`.
...
# curated_qwen_image_edit_transform_to_pencil_drawing

Curated workflow skill generated from `Qwen Image Edit - Transform to Pencil Drawing.json`.
...
- Original: `comfy-data/workflows/Qwen Image Edit - Transform to Pencil Drawing.json`
