---
name: workflow_qwen_image_edit_logo_on_product
description: >
  Workflow wrapper imported from `Qwen Image Edit - Logo on Product.json`.
...
# workflow_qwen_image_edit_logo_on_product

Imported workflow skill generated from `Qwen Image Edit - Logo on Product.json`.
