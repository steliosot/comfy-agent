---
name: workflow_qwen_image_edit_add_items
description: >
  Workflow wrapper imported from `Qwen Image Edit - Add Items.json`.
...
# workflow_qwen_image_edit_add_items

Imported workflow skill generated from `Qwen Image Edit - Add Items.json`.
