---
name: workflow_qwen_image_edit_remove_items
description: >
  Workflow wrapper imported from `Qwen Image Edit - Remove Items.json`.
...
# workflow_qwen_image_edit_remove_items

Imported workflow skill generated from `Qwen Image Edit - Remove Items.json`.
