---
name: workflow_qwen_image_edit_one_image_edit_change_ratio
description: >
  Workflow wrapper imported from `Qwen Image Edit - One Image Edit + Change Ratio.json`.
...
# workflow_qwen_image_edit_one_image_edit_change_ratio

Imported workflow skill generated from `Qwen Image Edit - One Image Edit + Change Ratio.json`.
