---
name: workflow_qwen_image_edit_colorize_photo
description: >
  Workflow wrapper imported from `Qwen Image Edit - Colorize Photo.json`.
...
# workflow_qwen_image_edit_colorize_photo

Imported workflow skill generated from `Qwen Image Edit - Colorize Photo.json`.
