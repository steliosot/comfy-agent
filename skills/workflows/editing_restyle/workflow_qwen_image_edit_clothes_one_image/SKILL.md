---
name: workflow_qwen_image_edit_clothes_one_image
description: >
  Workflow wrapper imported from `Qwen Image Edit - Clothes One Image.json`.
...
Imported workflow skill generated from `Qwen Image Edit - Clothes One Image.json`.
