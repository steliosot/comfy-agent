---
name: workflow_qwen_image_edit_replace_background
description: >
  Workflow wrapper imported from `Qwen Image Edit - Replace Background.json`.
...
# workflow_qwen_image_edit_replace_background

Imported workflow skill generated from `Qwen Image Edit - Replace Background.json`.
