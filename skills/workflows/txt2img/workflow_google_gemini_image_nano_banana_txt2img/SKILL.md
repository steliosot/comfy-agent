---
name: workflow_google_gemini_image_nano_banana_txt2img
description: >
  Workflow wrapper imported from `Google Gemini Image - Nano Banana - txt2img.json`.
...
# workflow_google_gemini_image_nano_banana_txt2img

Imported workflow skill generated from `Google Gemini Image - Nano Banana - txt2img.json`.
