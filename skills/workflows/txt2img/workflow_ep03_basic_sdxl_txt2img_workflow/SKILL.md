---
name: workflow_ep03_basic_sdxl_txt2img_workflow
description: >
  Workflow wrapper imported from `EP03 Basic SDXL TXT2IMG Workflow.json`.
...
Imported workflow skill generated from `EP03 Basic SDXL TXT2IMG Workflow.json`.
