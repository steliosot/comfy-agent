---
name: workflow_chatgpt_5_nano_prompt_generator
description: >
  Workflow wrapper imported from `ChatGPT 5 Nano - Prompt Generator.json`.
...
# workflow_chatgpt_5_nano_prompt_generator

Imported workflow skill generated from `ChatGPT 5 Nano - Prompt Generator.json`.
