---
name: workflow_wifi_transfer_portal
description: >
  Workflow wrapper imported from `Wifi Transfer Portal.json`.
...
# workflow_wifi_transfer_portal

Imported workflow skill generated from `Wifi Transfer Portal.json`.
