---
name: curated_hidream_i1_full_q8_gguf_text2image
description: >
  Curated ComfyUI workflow imported from `HiDream i1 Full Q8 GGUF text2image.json`.
...
Curated workflow skill generated from `HiDream i1 Full Q8 GGUF text2image.json`.
...
- `diffusion_model`: `hidream-i1-full-Q8_0.gguf` -> `models/diffusion_models`
...
- Original: `comfy-data/workflows/HiDream i1 Full Q8 GGUF text2image.json`
