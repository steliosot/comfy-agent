---
name: curated_z_image_turbo_txt2img_bf16_cn_pose_2
description: >
  Curated ComfyUI workflow imported from `Z Image Turbo txt2img bf16 CN Pose-2.json`.
...
# curated_z_image_turbo_txt2img_bf16_cn_pose_2

Curated workflow skill generated from `Z Image Turbo txt2img bf16 CN Pose-2.json`.
...
- Original: `comfy-data/workflows/Z Image Turbo txt2img bf16 CN Pose-2.json`
