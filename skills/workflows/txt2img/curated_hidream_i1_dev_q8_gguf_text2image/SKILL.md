---
name: curated_hidream_i1_dev_q8_gguf_text2image
description: >
  Curated ComfyUI workflow imported from `HiDream i1 Dev Q8 GGUF text2image.json`.
...
# curated_hidream_i1_dev_q8_gguf_text2image

Curated workflow skill generated from `HiDream i1 Dev Q8 GGUF text2image.json`.
...
- `diffusion_model`: `hidream-i1-dev-Q8_0.gguf` -> `models/diffusion_models`
...
- https://huggingface.co/city96/HiDream-I1-Dev-gguf/resolve/main/hidream-i1-dev-Q8_0.gguf?download=true
- https://huggingface.co/city96/HiDream-I1-Dev-gguf/tree/main
- https://www.youtube.com/@pixaroma

## Source

- Original: `comfy-data/workflows/HiDream i1 Dev Q8 GGUF text2image.json`
