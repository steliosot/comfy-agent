---
name: workflow_ep54_flux_dev_nunchaku_generate_vector_designs
description: >
  Workflow wrapper imported from `EP54 Flux Dev (Nunchaku) - Generate Vector Designs.json`.
...
Imported workflow skill generated from `EP54 Flux Dev (Nunchaku) - Generate Vector Designs.json`.
