---
name: workflow_preprocessor_config
description: >
  Workflow wrapper imported from `preprocessor_config.json`.
...
# workflow_preprocessor_config

Imported workflow skill generated from `preprocessor_config.json`.
