---
name: workflow_ep13_prompt_from_image
description: >
  Workflow wrapper imported from `EP13 Prompt from Image.json`.
...
# workflow_ep13_prompt_from_image

Imported workflow skill generated from `EP13 Prompt from Image.json`.
