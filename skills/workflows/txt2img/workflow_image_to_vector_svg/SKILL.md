---
name: workflow_image_to_vector_svg
description: >
  Workflow wrapper imported from `Image To Vector SVG.json`.
...
# workflow_image_to_vector_svg

Imported workflow skill generated from `Image To Vector SVG.json`.
