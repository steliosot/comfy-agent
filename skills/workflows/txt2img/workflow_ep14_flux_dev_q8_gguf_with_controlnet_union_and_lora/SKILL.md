---
name: workflow_ep14_flux_dev_q8_gguf_with_controlnet_union_and_lora
description: >
  Workflow wrapper imported from `Ep14 Flux Dev Q8 GGUF with ControlNet Union and LORA.json`.
...
# workflow_ep14_flux_dev_q8_gguf_with_controlnet_union_and_lora

Imported workflow skill generated from `Ep14 Flux Dev Q8 GGUF with ControlNet Union and LORA.json`.
...
- `lora`: `aidmaHyperrealism-FLUX-V0.1.safetensors` -> `models/loras`
