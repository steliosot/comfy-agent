---
name: curated_z_image_turbo_txt2img_bf16_cn_depth
description: >
  Curated ComfyUI workflow imported from `Z Image Turbo txt2img bf16 CN Depth.json`.
...
Curated workflow skill generated from `Z Image Turbo txt2img bf16 CN Depth.json`.
...
- Original: `comfy-data/workflows/Z Image Turbo txt2img bf16 CN Depth.json`
