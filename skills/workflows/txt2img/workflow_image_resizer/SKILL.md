---
name: workflow_image_resizer
description: >
  Workflow wrapper imported from `Image Resizer.json`.
...
# workflow_image_resizer

Imported workflow skill generated from `Image Resizer.json`.
