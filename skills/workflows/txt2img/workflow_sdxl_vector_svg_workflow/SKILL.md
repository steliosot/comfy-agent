---
name: workflow_sdxl_vector_svg_workflow
description: >
  Workflow wrapper imported from `SDXL Vector SVG Workflow.json`.
...
# workflow_sdxl_vector_svg_workflow

Imported workflow skill generated from `SDXL Vector SVG Workflow.json`.
