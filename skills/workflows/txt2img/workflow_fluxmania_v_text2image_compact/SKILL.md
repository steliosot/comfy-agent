...
description: >
  Workflow wrapper imported from `Fluxmania V - Text2Image COMPACT.json`.
...
# workflow_fluxmania_v_text2image_compact

Imported workflow skill generated from `Fluxmania V - Text2Image COMPACT.json`.
