---
name: workflow_chatgpt_5_nano_prompt_from_image
description: >
  Workflow wrapper imported from `ChatGPT 5 Nano - Prompt from Image.json`.
...
# workflow_chatgpt_5_nano_prompt_from_image

Imported workflow skill generated from `ChatGPT 5 Nano - Prompt from Image.json`.
