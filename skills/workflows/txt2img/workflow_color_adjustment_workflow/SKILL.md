---
name: workflow_color_adjustment_workflow
description: >
  Workflow wrapper imported from `Color Adjustment Workflow.json`.
...
# workflow_color_adjustment_workflow

Imported workflow skill generated from `Color Adjustment Workflow.json`.
