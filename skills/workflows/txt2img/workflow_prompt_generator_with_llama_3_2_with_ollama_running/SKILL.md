---
name: workflow_prompt_generator_with_llama_3_2_with_ollama_running
description: >
  Workflow wrapper imported from `Prompt Generator with LLAMA 3.2 with Ollama Running.json`.
...
# workflow_prompt_generator_with_llama_3_2_with_ollama_running

Imported workflow skill generated from `Prompt Generator with LLAMA 3.2 with Ollama Running.json`.
