...
description: >
  Workflow wrapper imported from `EP13 Generate Text with Instructions.json`.
...
# workflow_ep13_generate_text_with_instructions

Imported workflow skill generated from `EP13 Generate Text with Instructions.json`.
