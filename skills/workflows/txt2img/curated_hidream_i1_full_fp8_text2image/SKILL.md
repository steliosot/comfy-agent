---
name: curated_hidream_i1_full_fp8_text2image
description: >
  Curated ComfyUI workflow imported from `HiDream i1 Full fp8 text2image.json`.
...
Curated workflow skill generated from `HiDream i1 Full fp8 text2image.json`.
...
- `diffusion_model`: `hidream_i1_full_fp8.safetensors` -> `models/diffusion_models`
...
- Original: `comfy-data/workflows/HiDream i1 Full fp8 text2image.json`
