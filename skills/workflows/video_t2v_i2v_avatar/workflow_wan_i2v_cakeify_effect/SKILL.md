---
name: workflow_wan_i2v_cakeify_effect
description: >
  Workflow wrapper imported from `Wan i2v + Cakeify Effect.json`.
...
# workflow_wan_i2v_cakeify_effect

Imported workflow skill generated from `Wan i2v + Cakeify Effect.json`.
...
- `lora`: `cakeify_16_epochs.safetensors` -> `models/loras`
...
- https://huggingface.co/Remade-AI/Cakeify/resolve/main/cakeify_16_epochs.safetensors?download=true
