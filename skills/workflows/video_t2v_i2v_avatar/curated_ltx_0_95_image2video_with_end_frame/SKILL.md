---
name: curated_ltx_0_95_image2video_with_end_frame
description: >
  Curated ComfyUI workflow imported from `LTX 0.95 image2video with End Frame.json`.
...
# curated_ltx_0_95_image2video_with_end_frame

Curated workflow skill generated from `LTX 0.95 image2video with End Frame.json`.
...
- Original: `comfy-data/workflows/LTX 0.95 image2video with End Frame.json`
