---
name: workflow_wan_2_1_image_to_video_14b_720p
description: >
  Workflow wrapper imported from `Wan 2.1 Image to Video 14B 720p.json`.
...
- `diffusion_model`: `wan2.1-i2v-14b-720p-Q4_0.gguf` -> `models/diffusion_models`
