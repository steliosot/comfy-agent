---
name: workflow_wan_i2v_rotate_360_effect
description: >
  Workflow wrapper imported from `Wan i2v + Rotate 360 Effect.json`.
...
# workflow_wan_i2v_rotate_360_effect

Imported workflow skill generated from `Wan i2v + Rotate 360 Effect.json`.
...
- `lora`: `rotate_20_epochs.safetensors` -> `models/loras`
...
- https://huggingface.co/Remade-AI/Rotate/resolve/main/rotate_20_epochs.safetensors?download=true
