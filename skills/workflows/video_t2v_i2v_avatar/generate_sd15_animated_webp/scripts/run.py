#!/usr/bin/env python3
"""CLI wrapper for skills.workflows.video_t2v_i2v_avatar.generate_sd15_animated_webp.skill.run"""
...
def main():
    parser = argparse.ArgumentParser(description="Run generate_sd15_animated_webp skill")
    parser.add_argument(
        "--args",
        default="{}",
