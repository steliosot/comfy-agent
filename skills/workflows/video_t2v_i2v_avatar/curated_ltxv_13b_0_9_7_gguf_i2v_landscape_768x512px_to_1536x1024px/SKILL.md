---
name: curated_ltxv_13b_0_9_7_gguf_i2v_landscape_768x512px_to_1536x1024px
description: >
  Curated ComfyUI workflow imported from `LTXV 13b 0.9.7-GGUF i2v Landscape 768x512px to 1536x1024px.json`.
...
Curated workflow skill generated from `LTXV 13b 0.9.7-GGUF i2v Landscape 768x512px to 1536x1024px.json`.
...
- `diffusion_model`: `ltxv-13b-0.9.7-distilled-Q3_K_S.gguf` -> `models/diffusion_models`
- `vae`: `ltxv-13b-0.9.7-vae-BF16.safetensors` -> `models/vae`
- `clip`: `t5xxl_fp8_e4m3fn_scaled.safetensors` -> `models/clip`
...
- Original: `comfy-data/workflows/LTXV 13b 0.9.7-GGUF i2v Landscape 768x512px to 1536x1024px.json`
