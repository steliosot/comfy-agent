---
name: curated_wan_2_2_t2i_14b_gguf_4_step_lora_upscale_insta_portrait
description: >
  Curated ComfyUI workflow imported from `Wan 2.2 T2I 14b GGUF + 4 Step Lora + Upscale Insta Portrait.json`.
...
Curated workflow skill generated from `Wan 2.2 T2I 14b GGUF + 4 Step Lora + Upscale Insta Portrait.json`.
...
- Original: `comfy-data/workflows/Wan 2.2 T2I 14b GGUF + 4 Step Lora + Upscale Insta Portrait.json`
