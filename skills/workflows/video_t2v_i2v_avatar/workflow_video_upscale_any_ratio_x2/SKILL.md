---
name: workflow_video_upscale_any_ratio_x2
description: >
  Workflow wrapper imported from `Video Upscale Any Ratio X2.json`.
...
# workflow_video_upscale_any_ratio_x2

Imported workflow skill generated from `Video Upscale Any Ratio X2.json`.
