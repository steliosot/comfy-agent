---
name: workflow_wan_i2v_crush_effect
description: >
  Workflow wrapper imported from `Wan i2v + Crush Effect.json`.
...
# workflow_wan_i2v_crush_effect

Imported workflow skill generated from `Wan i2v + Crush Effect.json`.
...
- `lora`: `crush_20_epochs.safetensors` -> `models/loras`
...
- https://huggingface.co/Remade-AI/Crush/resolve/main/crush_20_epochs.safetensors?download=true
