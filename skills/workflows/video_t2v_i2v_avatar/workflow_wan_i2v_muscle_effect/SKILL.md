---
name: workflow_wan_i2v_muscle_effect
description: >
  Workflow wrapper imported from `Wan i2v + Muscle Effect.json`.
...
# workflow_wan_i2v_muscle_effect

Imported workflow skill generated from `Wan i2v + Muscle Effect.json`.
...
- `lora`: `muscle_18_epochs.safetensors` -> `models/loras`
...
- https://huggingface.co/Remade-AI/Muscle/resolve/main/muscle_18_epochs.safetensors?download=true
