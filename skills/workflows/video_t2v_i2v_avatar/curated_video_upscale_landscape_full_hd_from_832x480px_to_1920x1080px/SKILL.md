---
name: curated_video_upscale_landscape_full_hd_from_832x480px_to_1920x1080px
description: >
  Curated ComfyUI workflow imported from `Video Upscale Landscape Full HD from 832x480px to 1920x1080px.json`.
...
# curated_video_upscale_landscape_full_hd_from_832x480px_to_1920x1080px

Curated workflow skill generated from `Video Upscale Landscape Full HD from 832x480px to 1920x1080px.json`.
...
- Original: `comfy-data/workflows/Video Upscale Landscape Full HD from 832x480px to 1920x1080px.json`
