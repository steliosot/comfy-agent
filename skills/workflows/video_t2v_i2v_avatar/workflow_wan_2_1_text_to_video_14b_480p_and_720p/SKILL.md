...
description: >
  Workflow wrapper imported from `Wan 2.1 Text to Video 14B 480p and 720p.json`.
...
# workflow_wan_2_1_text_to_video_14b_480p_and_720p

Imported workflow skill generated from `Wan 2.1 Text to Video 14B 480p and 720p.json`.
...
- `diffusion_model`: `wan2.1-t2v-14b-Q8_0.gguf` -> `models/diffusion_models`
