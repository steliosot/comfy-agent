---
name: workflow_wan_i2v_lora_inflate_effect
description: >
  Workflow wrapper imported from `Wan i2v + Lora Inflate Effect.json`.
...
# workflow_wan_i2v_lora_inflate_effect

Imported workflow skill generated from `Wan i2v + Lora Inflate Effect.json`.
...
- `lora`: `inflate_20_epochs.safetensors` -> `models/loras`
...
- https://huggingface.co/Remade-AI/Inflate/resolve/main/inflate_20_epochs.safetensors?download=true
