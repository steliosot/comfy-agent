---
name: workflow_sonic_talking_avatar_square_576x576px
description: >
  Workflow wrapper imported from `Sonic Talking Avatar Square 576x576px.json`.
...
Imported workflow skill generated from `Sonic Talking Avatar Square 576x576px.json`.
