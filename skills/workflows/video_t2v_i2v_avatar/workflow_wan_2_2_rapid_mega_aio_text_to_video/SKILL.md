---
name: workflow_wan_2_2_rapid_mega_aio_text_to_video
description: >
  Workflow wrapper imported from `Wan 2.2 Rapid Mega AIO Text to Video.json`.
...
# workflow_wan_2_2_rapid_mega_aio_text_to_video

Imported workflow skill generated from `Wan 2.2 Rapid Mega AIO Text to Video.json`.
