...
description: >
  Workflow wrapper imported from `Ep49 Wan2 2.1 Vace GGUF Text To Video.json`.
...
Imported workflow skill generated from `Ep49 Wan2 2.1 Vace GGUF Text To Video.json`.
