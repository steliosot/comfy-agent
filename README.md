...
Additional SD1.5 workflow examples you can try:
...
Compatibility-focused node coverage examples:
...
## 6. Try the Simple Pipelining Examples

If you prefer a fluent chain style such as:
...
you can try the examples in:

```
workflow_examples_simple_pipelining
```

These keep the original `workflow_examples/` folder intact while
providing the simpler API style side by side.
...
## 8. Running in Parallel (Advanced)
