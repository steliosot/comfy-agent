...
class CleanupSkillTests(unittest.TestCase):
    def test_delete_image_job_rejects_non_image_prompt(self):
        from skills.infra.delete_image_job.skill import run

        with patch(
            "skills.infra.delete_image_job.skill.fetch_history_entry",
    ...
    def test_delete_video_job_rejects_non_video_prompt(self):
        from skills.infra.delete_video_job.skill import run

        with patch(
            "skills.infra.delete_video_job.skill.fetch_history_entry",
